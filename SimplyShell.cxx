...
class mainclass {
		public:
			void hlp () {
                ...
                string azioni2[7] = {"prttype [var name]","prtl [argument]","inputtype.list: list all input types","vcm: it create a virtual space for the commands","cif [condition]","funt [funt name] [command number]","cal [funt name] [commands arguments]"};
					for (int i = 0;i<9;i++){
						cout << azioni[i] << endl;
					}
					for (int i = 0;i<7;i++){
